import { LayoutDashboard, Users, Settings, Layers, Newspaper, UserCheck, GraduationCap, School, FileText, CalendarCheck, Clock, type LucideIcon } from "lucide-react";
...
export const sidebarGroups: NavGroup[] = [
  { label: "nav.group.overview", items: [{ title: "nav.dashboard", href: "/dashboard", icon: LayoutDashboard }] },
  {
    ...
    items: [
      { title: "attendance.nav", href: "/admin/attendance", icon: Clock, permission: ATTENDANCE_P.attendanceRead },
      ...
      { title: "documents.nav", href: "/admin/documents", icon: FileText, permission: DOCUMENT_P.documentRead },
      {
        ...
        icon: GraduationCap,
        children: [
          { title: "departments.nav", href: "/admin/departments", permission: PERSONNEL_P.personnelRead },
          { title: "curriculum.programs", href: "/admin/programs", permission: CURRICULUM_P.curriculumRead },
        ],
      },
      ...
      { title: "bookings.nav", href: "/admin/bookings", icon: CalendarCheck, permission: BOOKING_P.bookingRead },
    ],
  },
  {
